...
mshfile = 'TKC_Synth_DC_10mCells.msh'
...
for ii in range(len(geosurf)):
    ...
    indx = gocad2vtk(geosurf[ii][0],mesh, bcflag = geosurf[ii][1], inflag = geosurf[ii][2])
...
Mesh.TensorMesh.writeModelUBC(mesh,'VTKout_DC_10mCells.dat',model)

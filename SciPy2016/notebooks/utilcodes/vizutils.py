...
# def vizEJ(mesh, sigma, ind, f, src, airind, normal="Z", ftype="E", clim=None, xc=0, yc=0,zc=0., ax=None):
#     if normal == "Z":
#         if ax is None:
#             fig = plt.figure(figsize=(5*1.2, 5))
#             ax = plt.subplot(111)
...
#     if cb:
#         cb = plt.colorbar(dat[0], format="%1.1e", ticks=np.linspace(clim[0], clim[1], 3))
